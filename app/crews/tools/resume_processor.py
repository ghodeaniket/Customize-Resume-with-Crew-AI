...
def process_resume_tool(task_id: str, resume_service=None) -> Dict[str, Any]:
...
class ResumeProcessorTool(BaseTool):
    ...
    description = "Processes resumes and extracts text for analysis"
...
class JobMatcherTool(BaseTool):
    ...
    name = "JobMatcher"
    description = "Analyzes how well a resume matches job requirements"
